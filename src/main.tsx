...
async function seedDatabase() {
  try {
    ...
    const temasCount = await db.temas.count();
    if (temasCount === 0) {
      console.log("Nenhum tema encontrado, inserindo temas padrão...");

      // Lista completa de temas
      const temasPadrao = [
        "0. Mostre gratidão pelo que Deus e Cristo fizeram por você",
        ...
        "25. Lute contra o espirito do mundo",
        ...
        "30. Como melhorar a comunicação na familia",
        ...
        "44. Como os ensinos de Jesus podem ajudar vocé?",
        "45. Continue andando no caminho que leva à vida",
        "46. Fortaleça sua confianga em Jeová",
        ...
        "51. Será que a verdade da Bíblla está mudando a sua vida?",
        ...
        "56. Existe um lider em quem você pode confiar?",
        ...
        "63. Tem você espirito evangelizador?",
        "64. Você ama os prazeres ou a Deus?",
        "65. Como podemos ser pacificos num mundo cheio de ódio",
        "66. Você também vai participar na colheita?",
        "67. Medite na Biblia e nas criações de Jeová",
        ...
        "75. Mostre que vocé apola o direito de Jeová governar",
        "76. Principios biblicos - Podem nos ajudar a lidar com os probler",
        "77. Sempre mostrem hospitalidade",
        "78. Sirva a Jeová com um coração alegre",
        "79. Você vai escolher ser amigo de Deus?",
        "80. Você baseia sua esperança na ciência ou na Biblia?",
        "81. Quem está qualificado para fazer discipulos?",
        ...
        "85. Boas noticias num mundo violento",
        ...
        "99. Por que podemos confiar no que a Biblia diz?",
        ...
        "111. É possivel que a humanidade seja completamente curada?",
        ...
        "121. Uma familia mundial que será salva da destruição",
        ...
        "129. O que a Biblia diz sobre a Trindade?",
        ...
        "139. Sabedoria divina num mundo cientifico",
        ...
        "156. O Dia do Juizo - tempo de temor ou de esperança?",
        ...
        "179. Rejeite as fantasias do mundo, empenhe-se pelas realidades do reinc",
        "180. A Ressurreição - Por que essa esperança deve ser real para você",
        "181. Ja é mais tarde do que você imagina?",
      ...
      // Extrair número e título separadamente usando split e trim
      const temasParaAdicionar = temasPadrao.map((item) => {
